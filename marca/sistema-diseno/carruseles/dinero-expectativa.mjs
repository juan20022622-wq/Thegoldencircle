...
const L = [
  `<div class="cabeza">${llave}<h1 class="titular titular--xl" style="margin-top:calc(-24 * var(--u))">El dinero no cambia a las personas. <em>Las muestra.</em></h1><p class="cuerpo">Cómo lo cuidas dice más de ti que cuánto tienes.</p></div><span class="desliza" style="margin-top:auto;margin-bottom:calc(40 * var(--u))">Desliza</span>`,
